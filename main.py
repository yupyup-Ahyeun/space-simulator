...
parser.add_argument('--config', type=str, default='config/default/collaborative_transport.yaml', help='Path to the configuration file (default: --config=config.yaml)')
